...
#define SX1272_SS 10 	//Change by Sergio Rocha (default value is 8) (Teensy's -> 10) (Feather's ->8) (Arduino Pro Mini) (Arduino Mega 2566 -> 53)
#else
#define SX1272_SS 10	//Change by Sergio Rocha (default value is 8) (Teensy's -> 10) (Feather's ->8) (Arduino Pro Mini) (Arduino Mega 2566 -> 53)
#endif
...
/*
//Change by Sergio Rocha
#if defined AVR_ATmega1280 || defined AVR_ATmega2560  // Arduino Duemilanove, Diecimila, and NG
#define SX1272_SS 53 	
#elif defined MK20DX128 || defined MK20DX256 || MKL26Z64 // Teensy 3.0, 3.1, 3.2 and Teensy-LC
#define SX1272_SS 10	
#elif defined AVR_ATmega32U4 || defined SAMD21G18A || defined ARDUINO_AVR_PRO || defined ARDUINO_AVR_NANO || defined ARDUINO_AVR_MINI // Leonardo and Feather 32u4, Feather M0, Arduino Pro Mini, Nano and Mini
#define SX1272_SS 8
#endif
*/
...
public:
	...
	*/
    ...
    int8_t setPowerDBM(uint8_t dbm);
		...
		char *ftoa(char *a, double f, int precision);  //add by Hugo F.
